...
(function (window) {
  ...
  window.ENV = window.ENV || {
    ...
    UNIQUE_COLLECTION_IDS: defaults('${UNIQUE_COLLECTION_IDS}', [].join(',')),
    ...
    // For local development - don't forget to update webpack dev server
    GRAPH_QL_API: defaults('${GRAPH_QL_API}', 'https://hasura-opal.unique.network/v1/graphql'),
    //GRAPH_QL_API: defaults('${GRAPH_QL_API}', 'https://hasura-quartz.unique.network/v1/graphql'),
